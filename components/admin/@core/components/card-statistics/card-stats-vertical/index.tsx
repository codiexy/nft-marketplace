...
const CardStatsVertical = (props: CardStatsVerticalProps) => {
  ...
  return (
    <Card>
      <CardContent>
        <Box sx={{ display: 'flex', marginBottom: 5.5, alignItems: 'start', justifyContent: 'space-between' }}>
        ...
        <Box sx={{ marginTop: 1.5, display: 'flex', flexWrap: 'wrap', marginBottom: 1.5, alignItems: 'start' }}>
