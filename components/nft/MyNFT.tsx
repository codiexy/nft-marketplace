...
import { SITE_TOKEN, SITE_TOKEN_DOLLAR } from "utils";
...
function MyNFT(props: any) {
  ...
  return (
    <Link href={`/discover/${id}`} passHref>
      ...
      >
        <div className="myprofile_onsale_column_box border-2 dark:border-[#16151a] rounded-lg  cursor-pointer pb-3 mynft_new_wrap">
