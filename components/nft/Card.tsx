  ...
  return (
    ...
    <>
      ...
      >
        ...
        >
          <div className="myprofile_onsale_column_box m-1 p-2  border-2 dark:border-[#16151a] rounded-lg dark:bg-[#16151a] bg-[#fff] cursor-pointer home_explore newnfts_cards">
            ...
            <div className="myprofile_onsale_column_box_content relative text-center py-3 px-3 ">
              ...
              <div className="myprofile_onsale_column_box_creator  flex  items-center justify-between border-t-1 border-[#707a83] pt-4">
                ...
                {
                  price.eth > 0 && (
                    <div className="myprofile_onsale_column_box_creator_price text-left nftgrids_col_pricebox">
                      <h6 className=" dark:text-[#707a83] text-[#707a83] text-xs font-normal uppercase">Current Price</h6>
                      <span className="dark:text-[#fff] text-[#000] font-semibold text-xs flex nftgrids_col_price" >
                        <EthIcon style={{ marginTop: "0px"}}>
                          {parseFloat(parseFloat(price.eth).toFixed(4))}
                        </EthIcon>
                        (<DollarIcon style={{ marginTop: "0px"}}>
                          {parseFloat(parseFloat(price.dollar).toFixed(4))}
                        </DollarIcon>)
                      </span>
                    </div>
                  )
