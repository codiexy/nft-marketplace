...
const TrendingNfts = () => {
    ...
    return (
        <>
            <section className="explore_section trending-auction-card lg:pb-10  md:pb-10  pb-10  lg:pt-20  md:pt-20  lg:px-14 md:px-3 sm:px-2  pt-10 dark:bg-[#09080d] bg-[#fff] home_explore">
