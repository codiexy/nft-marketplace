...
function Details({ collection, id, useFilters, nfts }: DetailProps) {
  ...
  return (
    <>
      ...
      {/*********************/}
      <section className="collectionsingle lg:px-14 md:px-5 px-0 pb-5 pt-4" style={{ backgroundImage: 'url(' + collection.banner + ')', backgroundSize: "cover" }}>
                  ...
                  <h2 className="dark:text-white text-[#fff] font-semibold	text-lg	home-collection_heading_badge flex items-center">
                    {toCaptalize(collection.name)}
                    {
                      collection.isVarified ? (
                        ...
                        //   </Button>
                        // </Tooltip>
                        <Tooltip title={"Verified"} color="primary">
                          <Button auto flat>
                            <HiBadgeCheck />
                          </Button>
                        </Tooltip>
      ...
      <section className="collectionsingle collectionitems_col_section">
        <div className="container-fluid mx-auto ">
            ...
            >
              ...
              <Tabs>
                ...
                <TabPanel className="reatordetail_tabs  searchpage_tabs_panel">
                  <CommonFilter onToggle={handleToggle} useFilter={useFilters} id={id} pathname="collections" />
