...
import { SITE_TOKEN_DOLLAR } from "utils";
                ...
                <div className="myprofile_onsale_column_box m-1 p-2  border-2 dark:border-[#16151a] rounded-lg 	 dark:bg-[#16151a] bg-[#fff] cursor-pointer">
                    ...
                    <div className="myprofile_onsale_column_box_content  text-center py-3 px-3">
                        <div className="myprofile_onsale_column_box_content_headingrow flex  items-center justify-between ">
                            <Tooltip title={title}>
                                <h2 className="dark:text-white text-[#000] font-normal	lg:text-lg md:text-sm sm:text-sm  mt-4">
                                    {subString(title)}
                                </h2>
                            </Tooltip>
                        ...
                        <div className="myprofile_onsale_column_box_creator  border-t-1 border-[#707a83] pt-4">
                            ...
                            <div className="flex  items-center justify-between ">
                                <div className="myprofile_onsale_column_box_creator_price text-left nftgrids_col_pricebox">
                                    ...
                                    <span className="dark:text-[#fff] text-[#000] font-semibold text-xs flex nftgrids_col_price"  > <EthIcon/> {parseFloat(marketplace.data.minBid.eth)} | {SITE_TOKEN_DOLLAR} {parseFloat(marketplace.data.minBid.dollar)} </span>
                                </div>
